                ...
                <section  class="pad-top-40">
                    <div class="show-panel code-example">
                        <div class="show-panel-body code-example">
                            ...
                            <a href="#" name="jqGrid-hierarchical-elements-tree-and-no-border" class="title-anchor">&nbsp;</a>

                            <div class="code-container">
                                <div class="row flex-container code-header no-border-top">
                                    <div class="col-xs-8 module-description">
                                        <h4><strong>jqGrid with hierarchical elements and no border (Tree)</strong></h4>
                                    </div>
                                    <div class="col-xs-4">
                                        <a class="btn btn-default btn-sm pull-right btn-source collapsed"  data-toggle="collapse" href="#jq_with_hierarchical_elements_and_no_border" aria-expanded="false" aria-controls="jq_with_hierarchical_elements_and_no_border"><i class="fa fa-chevron-left"></i><i class="fa fa-chevron-right"></i><span>CODE</span></a>
                                    </div>
                                </div>
                                <div class="collapse code-example"  id="jq_with_hierarchical_elements_and_no_border">
                                    <!-- Nav tabs -->
                                    <ul class="nav nav-tabs code-example" role="tablist">
                                        <li role="presentation" class="active"><a href="#jq_with_hierarchical_elements_and_no_border_html_source" aria-controls="jq_with_hierarchical_elements_and_no_border_html" role="tab" data-toggle="tab">HTML</a></li>
                                        <li role="presentation"><a href="#jq_with_hierarchical_elements_and_no_border_js_source" aria-controls="jq_with_hierarchical_elements_and_no_border_js" role="tab" data-toggle="tab">JS</a></li>
                                        <li role="presentation"><a href="#jq_with_hierarchical_elements_and_no_border_css_source" aria-controls="jq_with_hierarchical_elements_and_no_border_css" role="tab" data-toggle="tab">CSS</a></li>
                                    </ul>

                                    <!-- Tab panes -->
                                    <div class="tab-content code-example">
                                        <div role="tabpanel" class="tab-pane html-source active" id="jq_with_hierarchical_elements_and_no_border_html_source">
                                            <pre class="language-html"><code class="language-html" data-showcase="code"></code></pre>
                                        </div>
                                        <div role="tabpanel" class="tab-pane js-source" id="jq_with_hierarchical_elements_and_no_border_js_source">
                                            <pre class="language-html"><code class="language-html" data-showcase="code"></code></pre>
                                        </div>
                                        <div role="tabpanel" class="tab-pane css-source" id="jq_with_hierarchical_elements_and_no_border_css_source">
                                            <pre class="language-html"><code class="language-html" data-showcase="code"></code></pre>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="pad-15" data-showcase="example" data-dependencies="main_style,main_script,jquery,jqgrid_css,jqgrid_source,jqgrid_locale_en_source,jqGrid_with_hierarchical_elements_and_no_border_init,jquery_ui_source,stickykit_source,tether_source,drop_source,drop_css">
                                            <table id="grid_table_with_hierarchy_and_no_border" class="table table-bordered word-break"></table>
            ...
            var dataSet = [
                {
                    ...
                    "lastnames": "Stark",
                    "usernames": "ironman",
                    "jobtypes": "Philantropist",
                    "codenames": "Iron Man",
                    "spirit_animals": "Tiger",
                    "data": "01/01/2018"
                },
                {
                    "ids": "2",
                    "firstnames": "Bruce",
                    "lastnames": "Banner",
                    "usernames": "hulk_smash",
                    "jobtypes": "Doctor",
                    "codenames": "The Hulk",
                    "spirit_animals": "Gorilla",
                    "data": "01/01/2018"
                },
                {
                    "ids": "3",
                ...
                },
                {
                    ...
                    "usernames": "rogerthat",
                    "jobtypes": "Captain",
                    "codenames": "Captain America",
                    "spirit_animals": "Eagle",
                    "data": "01/01/2018"
                },
                {
                    "ids": "6",
                    "firstnames": "Natalia",
                    "lastnames": "Romanova",
                    "usernames": "notawidsow",
                    "jobtypes": "Event planner",
                    "codenames": "Black Widsow",
                    "spirit_animals": "Spidser",
                    "data": "01/01/2018"
                },
                {
                    "ids": "7",
                ...
                },
                {
                    ...
                    "lastnames": "Charles",
                    "usernames": "tchiao",
                    "jobtypes": "Self-employed",
                    "codenames": "Black Panther",
                    "spirit_animals": "Jaguar",
                    "data": "01/01/2018"
                },
                {
                    "ids": "9",
                    "firstnames": "Victor",
                    "lastnames": "Shade",
                    "usernames": "imallseeing",
                    "jobtypes": "Self-employed",
                    "codenames": "The Vision",
                    "spirit_animals": "Dolphin",
                    "data": "01/01/2018"
                },
                {
                    "ids": "10",
                    ...
                    "usernames": "photon",
                    "jobtypes": "Self-employed",
                    "codenames": "Captain Marvel",
                    "spirit_animals": "Mustang",
                    "data": "01/01/2018"
    ...
    $(document).ready(function () {
        $("#grid_table_with_hierarchy").jqGrid({
            ...
            loadComplete: function(){
                ...
                $this.find('div').find('#ui-jqgrid-view table-responsive').css({'border-right': '0'});
                ...
                $this.closest('.ui-jqgrid-view').find('tr:visible:last').find('td').css({'border-bottom': '0'}); //ana
...
<script type="text/javascript" data-dependency-name="jqGrid_with_hierarchical_elements_and_no_border_init">
    function getListingDummyDataForHierarchicalElements() {
    ...
    $(document).ready(function () {
        $("#grid_table_with_hierarchy_and_no_border").jqGrid({
            autoResizing: { compact: true },
            data: getListingDummyDataForHierarchicalElements(),
            datatype: "local",
            sortable: true,
            colNames: ['Id', 'First Name', 'Last Name', 'Username', 'Hobby', 'Nickname', 'Spiritual Animal', 'Actions'],
            colModel: [
                ...
                { name: 'codename',     index: 'codename' , sortable:false },
                { name: 'spirit_animal',index: 'spirit_animal', sortable:false }, 
                { name: 'actions',      index: 'actions', formatter: PhotonDataFormatter.actionsButtons , sortable:false }
            ],
            loadComplete: function(){
                //remove border
                $this = $(this);
    ...
    $(document).ready(function () {
        $("#grid_table_with_subgrid").jqGrid({
            ...
            subGridRowExpanded: function(subgrid_id, row_id) {
                ...
                // jQuery('#'+subgrid_table_id).sortable('destroy');
                ...
                jQuery("#"+subgrid_table_id).jqGrid({
                    ...
                    colNames: ['Id', 'First Name', 'Last Name', 'Username', 'Hobby', 'Nickname', 'Spiritual Animal'],
                    colModel: [
                        { name: 'ids',           index: 'id', hidden: true, width: "20" },
                        { label: 'First Name', name: 'firstnames',    index: 'firstname', key: true, width: "100" },
                        { label: 'Last Name', name: 'lastnames',     index: 'lastname' },
                        { label: 'Username', name: 'usernames',     index: 'username' },
                        { label: 'Hobby', name: 'jobtypes',      index: 'jobtype' },
                        { label: 'Nickname', name: 'codenames',     index: 'codename' },
                        { label: 'Spiritual Animal', name: 'spirit_animals',index: 'spirit_animal' }
                    ],
                    height: '100%',
                    rowNum:5,
                    sortname: 'num',

        ...
        <script type="text/javascript" data-dependency-name="messages_types_init">
            $(document).ready(function () {
                ...
                $('#show_info_full_color').on('click',function(){
                    addNotification('<i class="fa fa-info-circle"></i><span>Prepare yourself! This is an informational message: Information</span>', 'info-full-color');
                });
                ...
                $('#show_warning_full_color').on('click',function(){
                    addNotification('<i class="fa fa-warning"></i><span>Are you prepared? This is a warning message: Warning</span>', 'warning-full-color');
                });
                $('#show_error').on('click',function(){
                    addNotification('<i class="fa fa-exclamation-circle"></i><span>Oh SNAP! This is an error message: Run!</span>', 'danger');
                });
                $('#show_error_full_color').on('click',function(){
                    addNotification('<i class="fa fa-exclamation-circle"></i><span>Oh SNAP! This is an error message: Run!</span>', 'danger-full-color');
                });
            })
        </script>

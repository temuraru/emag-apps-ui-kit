                            ...
                            <div class="pad-sep-20">
                                <div class="row">
                                    <div class="col-lg-8 col-lg-offset-2">
                                        <div class="btn-group btn-group-justified" role="group" aria-label="...">
                                            <div class="btn-group" role="group">
                                                <button type="button" id="confirmation_alert" class="btn btn-default">Confirmation alert modal</button>
                                            </div>
                                            <div class="btn-group" role="group">
                                                <button type="button" id="confirmation_alert_no_overlay" class="btn btn-default">Confirmation alert modal - No overlay</button>
                                            </div>
                                            <div class="btn-group" role="group">
                                                <button type="button" id="error_alert" class="btn btn-default">Error alert modal</button>
                                            </div>
                                            <div class="btn-group" role="group">
                                                <button type="button" id="error_alert_no_overlay" class="btn btn-default">Error alert modal - No overlay</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>

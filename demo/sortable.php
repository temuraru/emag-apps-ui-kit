                    ...
                    <div class="show-panel code-example">
                        <div class="show-panel-body code-example">
                            ...
                            <div class="code-container">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="pad-15 no-padding-bottom" data-showcase="example" data-dependencies="main_style,main_script,jquery,jquery_ui_source,sortable,sortable_css">
                                            <div class="row">
                                                <div class="col-sm-12">

                                                    <div id="draggable_container" class="panel-body makeSortable no-margin-left-right no-padding-bottom">
...
<script type="text/javascript" data-dependency-name="sortable">
    $(document).ready(function () {

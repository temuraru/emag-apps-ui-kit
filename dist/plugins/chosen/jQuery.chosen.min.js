...
j.data().chosen.no_results(r),h.width(f(h,n))}else j.data().chosen.no_results(h.val());return null!=b.success&&b.success(g),h.val(o)}},$this[0].timer=setTimeout(function(){return g&&g.abort(),g=a.ajax(i)},i.afterTypeDelay))},l)})})}}(jQuery);